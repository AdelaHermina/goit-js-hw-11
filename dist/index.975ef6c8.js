...
const lightbox = new (0, _simplelightboxDefault.default)(".lightbox", {
    captionsData: "alt",
    captionDelay: 250,
    enableKeyboard: true,
    showCounter: false,
...
(0, _refsJs.elements).searchForm.addEventListener("submit", onFormSubmit);
document.addEventListener("DOMContentLoaded", hideLoader);
async function onFormSubmit(e) {
    e.preventDefault();
    (0, _refsJs.elements).galleryEl.innerHTML = "";
    page = 1;
    searchQuery = (0, _refsJs.elements).searchInput.value.trim();
    if (searchQuery === "") {
        (0, _notiflixNotifyAio.Notify).info("Please enter a search query.");
        return;
    }
    try {
        showLoader();
        const response = await (0, _apiJs.getImages)(searchQuery, page);
        totalHits = response.data.totalHits;
        const hits = response.data.hits;
        if (hits.length === 0) (0, _notiflixNotifyAio.Notify).failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${totalHits} images.`);
            (0, _renderJs.renderGallery)(hits);
            lightbox.refresh();
        ...
        (0, _refsJs.elements).searchInput.value = "";
        hideLoader();
    } catch (err) {
        console.log(err);
        (0, _notiflixNotifyAio.Notify).failure(err);
        hideLoader();
    }
}
...
function showLoader() {
    (0, _refsJs.elements).loaderEl.style.display = "block";
}
function hideLoader() {
    (0, _refsJs.elements).loaderEl.style.display = "none";
}
function onScrollHandler() {
    const { scrollTop, scrollHeight, clientHeight } = document.documentElement;
    const scrollThreshold = 300;
    if (scrollTop + clientHeight >= scrollHeight - scrollThreshold && !isLoadingMore && !reachedEnd) loadMore();
}

},{"./render.js":"lPFSt","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./api.js":"8Zgej","./refs.js":"ep9VC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lPFSt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function renderGallery(hits) {
    ...
    (0, _refsJs.elements).galleryEl.insertAdjacentHTML("beforeend", markup);
}

},{"./refs.js":"ep9VC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ep9VC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"kaxSc":[function() {},{}],"8Zgej":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function getImages(searchQuery, page) {
    ...
    const response = await (0, _axiosDefault.default)(BASE_URL, options);
    return response;
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["igKGj","8lqZg"], "8lqZg", "parcelRequired7c6")
